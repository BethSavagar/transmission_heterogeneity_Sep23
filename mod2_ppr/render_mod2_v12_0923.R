...
source(paste0(mod_filepath, "/functions/vfPPR_Metapop_v12_0923.R")) # simulate transmission between units (meta-pop), with vaccination.
...
source(paste0(mod_filepath, "/data-parameters/fixed-pars_v12_0923.R")) # vaccination over 12 timesteps
...
for(i in 1:nrow(params)){
  ...
  # write.csv(params, paste0(mod_filepath, "/output/output_mod2_v12_",Sys.Date(), ".csv"))
}

# Save completed output
tdate <- Sys.Date()
filename <- paste0("output_mod2_v12_", tdate, ".csv")
